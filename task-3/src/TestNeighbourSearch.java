...
public class TestNeighbourSearch {
        static BiConsumer<List<Integer>, List<Integer>> testLambda = (in, exp) -> {
            ...
            List<Integer> out = Solution.getUnvisitedNeighbours(in, v);
    ...
    public void testNeighboursOnSecondmostOuterLayersWithOverlap() {
        ...
        testLambda.accept(List.of(52), List.of(35, 37, 42, 46, 58, 62));
        testLambda.accept(List.of(25, 52), List.of(
            8, 10, 19, 35, 37, 40, 42, 46, 58, 62));
